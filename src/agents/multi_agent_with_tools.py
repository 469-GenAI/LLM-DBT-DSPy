...
def create_mas_coordinate_l0(model_id="openai/gpt-oss-120b"):
...
if __name__ == "__main__":
    with Path("src/agents/data/outputs/facts_and_productdescriptions.json").open("r", encoding="utf-8") as f:
    ...
    for scenario in tqdm(scenarios, desc="Processing Pitches for Sharks", unit="pitch"):
        ...
        # Get the metrics after the start up team run the prompt
