...
# Tavily API key is still needed for search tools
...
class AsyncSpecialistTeamRAGTavily:
    ...
    def __init__(self, output_dir, log_file_path, specialist_model_id="gpt-4o", pitch_model_id="gpt-4o", max_tokens=4096, temperature=0.7, debug_mode=True):
        ...
        def create_specialist_model():
            ...
            model_to_use = model_map.get(self.specialist_model_id, "gpt-4o")
            return LiteLLM(
                id=model_to_use,
        ...
        def create_pitch_model():
            ...
            model_to_use = model_map.get(self.pitch_model_id, "gpt-4o")
            return LiteLLM(
                id=model_to_use,
                max_tokens=self.max_tokens,
                temperature=self.temperature
...
def setup_arg_parser():
    ...
    parser.add_argument('--specialist-model', type=str, default='gpt-4o',
                        help='Model ID to use for specialist agents (default: gpt-4o)')
    
    parser.add_argument('--pitch-model', type=str, default='gpt-4o',
                        help='Model ID to use for pitch agents (default: gpt-4o)')
